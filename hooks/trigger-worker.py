...
GLOBAL_COOLDOWN_SECONDS = float(os.environ.get("TRIGGER_COOLDOWN_SECONDS", "60"))
SESSION_COOLDOWN_SECONDS = float(os.environ.get("TRIGGER_SESSION_COOLDOWN_SECONDS", "60"))
