...
description: Polish user-facing product surfaces such as pricing pages, plan cards, model/settings pickers, App Store/TestFlight metadata, icons, categories, onboarding, and marketing UI by reading real reference products and the product's enforced source of truth before writing copy or visuals.
---
